...
public class CorteDetalleViewModel {
    ...
    private String pieTexto; //30 días para corte o Servicio cortado
    private double saldoPendiente; // deuda + interés, sin costo de reactivación
    ...
    public String getDeudaOriginal() {
        return deudaOriginal;
    }

    public void setDeudaOriginal(String deudaOriginal) {
    ...
    public void setInteresAcumulado(String interesAcumulado) {

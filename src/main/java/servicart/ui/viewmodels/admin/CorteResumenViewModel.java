...
public class CorteResumenViewModel {
    ...
    public int getTotalCortados() {
        return totalCortados;
    }

    public void setTotalCortados(int totalCortados) {
    ...
    public String getTotalInteresesGenerados() {
        return totalInteresesGenerados;
    }

    public void setTotalInteresesGenerados(String totalInteresesGenerados) {
        this.totalInteresesGenerados = totalInteresesGenerados;
    }
}
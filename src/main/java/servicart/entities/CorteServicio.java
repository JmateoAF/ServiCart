...
public class CorteServicio implements Serializable, Identificable {
    ...
    public double getCostoReactivacionPagado() {
        return costoReactivacionPagado;
    }

    public void setCostoReactivacionPagado(double costoReactivacionPagado) {
        this.costoReactivacionPagado = costoReactivacionPagado;
    }

    public EstadoCorte getEstadoCorte() {
        return estadoCorte;
    }

    public void setEstadoCorte(EstadoCorte estadoCorte) {
    ...
    public boolean estadoCortado() {
        return estadoCorte == EstadoCorte.CORTADO;
    }
}

 ...
 */
public enum Empresa {
    ETAPA(1),         // Llama automáticamente al constructor con código 1
    CENTROSUR(2),     // Llama automáticamente al constructor con código 2
    EMAC(3),          // Llama automáticamente al constructor con código 3
    FIBRAMAX(4);      // Llama automáticamente al constructor con código 4
